        ...
        <div className="card glass group p-8 rounded-3xl relative h-[320px] overflow-hidden hover:-translate-y-2 hover:bg-[rgba(16,20,60,0.6)] transition duration-300 border-primary/30">
          ...
          <div className="flex gap-5">
            <a
              ...
              target="_blank"
              className="absolute bottom-5 inline-block left-8 z-10 text-sm border border-primary/50 px-3 py-1 rounded-full hover:bg-primary hover:text-white transition"
            >
              <img
            ...
            <a
              href="https://leetcode.com/abhayanthk/"
              target="_blank"
              className="absolute bottom-5 inline-block left-8 z-10 text-sm border border-primary/50 px-3 py-1 rounded-full hover:bg-primary hover:text-white transition"
            >
              <img
